...
public class DAO_mCand {
	...
	public static synchronized boolean processaFimFila(String idCand){
		...
		try{
			...
			/*Startando uma transação, se na chamada do método executeUpdate der algo errado
			 *  será dado rollback
			 */
	...
	public static synchronized boolean confirmaSelecao(int idConcurso, String idCand, int vaga, String unidade, String lotacao, String localiz) throws SQLException{
		try{
			ConexaoBD a = new ConexaoBD();
			a.iniciaBd();
			Connection c = a.getConexao();
